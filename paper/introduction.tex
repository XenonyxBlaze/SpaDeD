...
\begin{itemize}
    ...
    \item \textbf{Fine-Grained Multi-Region Feature Disambiguation:} We reframe deepfake detection as a multi-region fine-grained classification task. By regularizing attention heads with a dual Regional Independence Loss ($\mathcal{L}_{RIL}$) and Attention Guided Data Augmentation (AGDA), we penalize spatial co-activation and feature redundancy, encouraging complementary coverage across distinct facial regions.
