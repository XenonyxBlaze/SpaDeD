...
\begin{table}[ht]
    ...
    \begin{tabular}{l|c|c|l}
        ...
        DFDC & 2020 & 128,454 videos & Large scale, real-world perturbations. \\
        WildDeepfake & 2021 & 7,314 videos & Collected from internet sources. \\
        \textbf{DF40} & \textbf{2024} & \textbf{40 methods} & \textbf{Unparalleled diversity of generation techniques.} \\
        \bottomrule
    \end{tabular}
    }
\end{table}
