...
\item \textbf{Data and Code Availability} Benchmark datasets (DF40, FaceForensics++, Celeb-DF) are publicly accessible. The code implementation, trained model checkpoints, and experimental split protocols are available at \url{https://github.com/XenonyxBlaze/SpaDeD}.
