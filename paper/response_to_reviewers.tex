...
\begin{table}[ht]
\centering
\caption{Statistical Significance across Cross-Forgery Evaluation Conditions (Table 9 in Manuscript, $df=4$)}
...
\textbf{Train FS $\to$ Test FR} & $+4.2\%$ & $11.611$ & $0.00031$ & $0.0025$ & \textbf{Significant} ($q = 0.0008$) \\
\textbf{Train FS $\to$ Test EFS} & $+3.4\%$ & $7.694$ & $0.0015$ & $0.0120$ & \textbf{Significant} ($q = 0.0023$) \\
\textbf{Train FS $\to$ Test FE} & $+2.7\%$ & $8.409$ & $0.0011$ & $0.0088$ & \textbf{Significant} ($q = 0.0022$) \\
\textbf{Train FR $\to$ Test FS} & $+7.7\%$ & $17.424$ & $0.00006$ & $0.0005$ & \textbf{Significant} ($q = 0.0005$) \\
\textbf{Train FR $\to$ Test FR} & $+2.1\%$ & $7.457$ & $0.0017$ & $0.0136$ & \textbf{Significant} ($q = 0.0023$) \\
\textbf{Train FR $\to$ Test EFS} & $+2.3\%$ & $6.358$ & $0.0031$ & $0.0248$ & \textbf{Significant} ($q = 0.0035$) \\
\textbf{Train FR $\to$ Test FE} & $+5.1\%$ & $14.099$ & $0.00015$ & $0.0012$ & \textbf{Significant} ($q = 0.0006$) \\
\bottomrule
\end{tabular}
}
\end{table}
